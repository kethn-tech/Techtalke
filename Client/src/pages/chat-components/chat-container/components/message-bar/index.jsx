...
import { Smile, Send, Code, Zap } from "lucide-react";
...
const MessageBar = () => {
  ...
  useEffect(() => {
    if (socket && selectedChatData && userInfo) {
      ...
      const timer = setTimeout(() => {
        console.log(`Emitting markMessagesAsRead - sender: ${selectedChatData._id}, recipient: ${userInfo._id}`);
  ...
  return (
    <motion.div
      ...
      className="relative p-3 backdrop-blur-xl bg-gradient-to-r from-slate-900/95 via-slate-800/95 to-slate-900/95 border-t border-slate-700/30"
    >
