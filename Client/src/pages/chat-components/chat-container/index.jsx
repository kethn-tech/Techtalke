  ...
  return (
    <div className="flex-1 h-dvh md:h-screen bg-slate-950 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Top-right cyan glow */}
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-cyan-500/15 via-blue-500/10 to-transparent rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '4s' }} />
        
        {/* Bottom-left indigo glow */}
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-indigo-500/15 via-purple-500/10 to-transparent rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '6s', animationDelay: '2s' }} />
        
        {/* Center floating orb */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-blue-500/8 via-cyan-500/8 to-indigo-500/8 rounded-full blur-2xl animate-pulse"
        ...
        {Array.from({ length: 12 }).map((_, i) => (
          <div
            ...
            style={{
              ...
              top: `${Math.random() * 100}%`,
              animation: `float-${i % 3} ${8 + Math.random() * 6}s linear infinite`,
