...
import { MessageSquare, Users, Menu, X, Coffee, Sparkles, UserPlus, Trash2, Search, Hash, Zap, Shield, Bell, Settings, Radio } from "lucide-react";
    ...
    <>
      ...
      <motion.div
        ...
        className={`
          ...
          flex flex-col
          ${isMobile 
            ? `fixed inset-y-0 left-0 z-[60] w-full max-w-sm ${isMobileMenuOpen ? 'pointer-events-auto' : 'pointer-events-none'}` 
        ...
        <div className="flex-1 overflow-hidden relative z-10">
          ...
          >
            ...
            >
              ...
              <motion.div
              >
                <Coffee size={18} className="text-orange-400 group-hover:text-orange-200 relative z-10 transition-colors duration-300 w-3.5 h-3.5" />
              </motion.div>
            </motion.button>
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
              >
                <Users size={16} className="text-cyan-400 relative z-10 w-3.5 h-3.5" />
              </motion.div>
            </motion.button>
              ...
              <div className="space-y-2">
                <AnimatePresence mode="popLayout">
                  {allContacts.map((contact, index) => {
                    ...
                    const canDelete = isGroup && userInfo && (contact.creator === userInfo._id || contact.admins?.includes(userInfo._id));
                    ...
                    return (
                      <motion.div
                        key={contact._id}
                        layout
                        initial={{ opacity: 0, x: -80, scale: 0.7, rotate: -10 }}
                      ...
                      >
                        <motion.div
                          ...
                          whileTap={{ scale: 0.97, x: 4, transition: { duration: 0.15 } }}
                          ...
                          onClick={() => !isDeleting && handleContactClick(contact)}
                        ...
                        >
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              >
                                {contact.image ? (
                                  <AvatarImage src={contact.image} alt={contact.displayName} />
                                ) : isGroup ? (
                                  <motion.div 
                            ...
                            <div className="flex items-center justify-between mb-2">
                              ...
                              >
                                ...
                                <motion.span
                                  ...
                                  transition={{ duration: 3, repeat: Infinity }}
                                  className={isSelected ? "bg-gradient-to-r from-white via-cyan-200 to-white bg-clip-text text-transparent" : ""}
                                  style={{ backgroundSize: "200% 200%" }}
                                >
                                  {contact.displayName}
                                </motion.span>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <motion.div
                                  ...
                                  transition={{ duration: contact.isOnline ? 2 : 3, repeat: Infinity }}
                          ...
                          {canDelete && (
                            <motion.button
                              ...
                              whileTap={{ scale: 0.8, rotate: -5, transition: { duration: 0.1 } }}
                              ...
                              {isDeleting ? (
                                ...
                                >
                                  <motion.div 
                                    ...
                                    animate={{
                                      borderColor: ["#fca5a5", "#f87171", "#ef4444", "#fca5a5"]
                                    }}
