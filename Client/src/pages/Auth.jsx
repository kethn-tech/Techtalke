...
import { Mail, Lock, Eye, EyeOff, Loader2, MessageCircle, Users, Shield, Zap, Globe, Cpu, Network, Import } from "lucide-react";
...
const Auth = () => {
  ...
  useEffect(() => {
    ...
    waveSpeed: 0.10,          // animation speed
  ...
  return (
    ...
    <div ref={vantaRef} className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-xl text-cyan-300 font-mono">A Community Connection</span>
                  </motion.div>
                </div>
              </motion.div>        
            </div>
              ...
              <div className="relative z-10">
                ...
                >
                  <div className="inline-flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-3xl font-bold text-white">Secure Access</h3>
                  </div>
                </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="relative group">
                      ...
                      {/* Focus indicator */}
                      <motion.div 
                        className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full scale-x-0 group-focus-within:scale-x-100 transition-transform duration-300"
                      />
                    </div>
                  </motion.div>
