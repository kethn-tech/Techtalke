          ...
          <div className="space-y-6 relative z-10">
            ...
            >
              ...
              <select
                ...
                className="w-full px-4 py-4 bg-gray-800/50 border border-gray-700/50 rounded-xl text-white focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 focus:bg-gray-800/80 transition-all duration-300 backdrop-blur-sm"
              >
                {languages.map((lang) => (
                  <option
                    key={lang.value}
            ...
            >
              ...
              <motion.button
                ...
                className="flex-1 py-4 px-6 rounded-xl font-medium bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed text-white transition-all duration-200 shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                Create Session
