          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {users.map((user) => (
                    <tr key={user._id} className="border-b border-dark-accent/10 hover:bg-dark-accent/10">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-400">
                              {user.profileSetup ? 'Profile Complete' : 'Profile Incomplete'}
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-2 py-1 rounded-full text-xs ${user.role === 'admin' ? 'bg-red-500/20 text-red-400' : user.role === 'moderator' ? 'bg-yellow-500/20 text-yellow-400' : 'bg-green-500/20 text-green-400'}`}>
                          {user.role}
                        </span>
                      </td>
                        ...
                        <div className="flex items-center gap-2">
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button variant="outline" size="sm" className="h-8 px-2  text-cyan-950 bg-slate-200  hover:bg-dark-accent/30">
                                Actions
                              </Button>
                            </DropdownMenuTrigger>
          ...
          <div className="py-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <Button
                ...
                className={selectedRole === 'user' ? 'bg-green-600 hover:bg-green-700' : 'hover:bg-dark-accent/30'}
              ...
              <Button
                ...
                className={selectedRole === 'moderator' ? 'bg-yellow-600 hover:bg-yellow-700' : 'hover:bg-dark-accent/30'}
              ...
              <Button
                ...
                className={selectedRole === 'admin' ? 'bg-red-600 hover:bg-red-700' : 'hover:bg-dark-accent/30'}
