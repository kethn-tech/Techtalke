...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      icon: <Group className="h-8 w-8 text-purple-500" />,
  ...
  const adminActions = [
    ...
    {
      title: 'Manage Groups',
      description: 'View and manage group chats',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
              ...
              <table className="w-full">
                ...
                <tbody>
                  {stats?.recentUsers?.map((user, index) => (
                    <tr key={index} className="border-b border-dark-accent/10 hover:bg-dark-accent/10">
                      <td className="py-3">
          ...
          <div className="mt-4">
            <Button 
              variant="outline" 
              className="w-full text-cyan-950 bg-slate-200 hover:bg-dark-accent/30 "
              onClick={() => navigate('/admin/users')}
            >
                    All Users
            </Button>
