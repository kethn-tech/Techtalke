        ...
        <div className="max-w-7xl mx-auto">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <p className="text-slate-400 text-xl font-semibold">
                        Welcome back, <span className="text-white font-bold">{userInfo?.firstName || "Admin"}</span>
                      </p>
                  ...
                  <Card className="relative bg-slate-800/40 backdrop-blur-2xl border-slate-700/50 hover:border-slate-600/70 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 rounded-3xl overflow-hidden">
                    ...
                    <CardHeader className="pb-4 relative z-10">
                      <div className="flex items-center justify-between">
                        ...
                        <div className={`p-3 rounded-2xl bg-gradient-to-br ${stat.gradient} bg-opacity-20 group-hover:bg-opacity-30 transition-all shadow-xl shadow-${stat.shadowColor} group-hover:scale-110 duration-300 border border-white/10`}>
                          {stat.icon}
                        </div>
                      </div>
                    </CardHeader>
                  ...
                  >
                    ...
                    <CardContent className="p-8 relative z-10 h-full flex flex-col">
                      <div className="flex items-start justify-between mb-6">
                        <div className={`p-4 rounded-3xl bg-gradient-to-br ${action.gradient} bg-opacity-20 group-hover:bg-opacity-30 transition-all shadow-2xl shadow-${action.shadowColor} group-hover:scale-110 duration-300 border border-white/10`}>
                          {action.icon}
                        </div>
              ...
              <CardContent className="p-8">
                {loading ? (
                  <div className="flex flex-col justify-center items-center py-16">
                    ...
                    <p className="text-slate-400 font-medium text-lg">Loading recent users...</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-6 rounded-2xl bg-gradient-to-r from-slate-900/40 to-slate-800/40 hover:from-slate-800/60 hover:to-slate-700/60 transition-all duration-300 border border-slate-700/30 hover:border-slate-600/50 backdrop-blur-sm">
                          <div className="flex items-center gap-5">
                            <div className="relative">
                              ...
                              <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-r from-emerald-400 to-green-400 rounded-full border-3 border-slate-800 shadow-lg flex items-center justify-center">
                    ...
                    {(!stats?.recentUsers || stats.recentUsers.length === 0) && (
                      <div className="text-center py-20">
                        ...
                        <p className="text-slate-300 text-2xl font-bold mb-3">No users found</p>
          ...
          >
            <div className="flex items-center gap-3 px-6 py-3 bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-slate-700/50">
              ...
              <span className="text-slate-300 font-semibold">System Status: Online</span>
            </div>
            
            <div className="flex items-center gap-3 px-6 py-3 bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-slate-700/50">
              <Globe className="h-4 w-4 text-cyan-400" />
              <span className="text-slate-300 font-semibold">Global Access</span>
            </div>
            
            <div className="flex items-center gap-3 px-6 py-3 bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-slate-700/50">
              <Eye className="h-4 w-4 text-indigo-400" />
              <span className="text-slate-300 font-semibold">Monitoring Active</span>
            </div>
          </motion.div>
        </div>
      </div>
